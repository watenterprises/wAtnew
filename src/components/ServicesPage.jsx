...
const SERVICES = [
  {
    ...
    description: "Premium, conversion-focused websites built with modern frameworks. Fully responsive, fast, and scalable to grow with your business.",
  ...
  },
  {
    ...
    description: "Create a memorable brand with logos, color systems, typography, and comprehensive brand guidelines that stand out.",
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description: "User-centered design that delights and converts. From wireframes to high-fidelity prototypes, we craft intuitive experiences.",
  ...
  },
  {
    ...
    description: "Data-driven strategies to maximize ROI. We align your digital presence with business goals through research and optimization.",
  ...
  },
  {
    ...
    description: "Complete online stores with seamless checkout, inventory management, and integrations that drive sales and customer loyalty.",
  ...
  },
  {
    icon: (
      <svg width="42" height="42" fill="none" viewBox="0 0 42 42">
        ...
        <path d="M10 35c0-6 5-11 11-11s11 5 11 11" stroke="#19a1ff" strokeWidth="2.2" strokeLinecap="round"/>
      </svg>
    ),
    title: "Ongoing Support & Maintenance",
    description: "Keep your website fresh, secure, and performing optimally. Regular updates, bug fixes, and feature enhancements included.",
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <p style={{
            ...
            From strategy to execution, we provide end-to-end digital solutions tailored to your business needs. Let's build something extraordinary together.
          </p>
        </div>
          ...
          {SERVICES.map((service, idx) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 12px 56px rgba(0,0,0,0.32), 0 0.5px 10px 0 rgba(100,100,100,0.08) inset";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = "0 8px 44px rgba(0,0,0,0.24), 0 0.5px 10px 0 rgba(100,100,100,0.08) inset";
              }}
            >
              {/* Icon */}
              <div style={{
